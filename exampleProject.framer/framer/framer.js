...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LayerDraggable = (function(superClass) {
	  ...
	  LayerDraggable.prototype._touchMove = function(event) {
	    var frame, point, scaleX, scaleY, touchEvent;
	    if (!this.enabled) {
	      return;
	    }
	    ...
	    if (this.horizontal) {
	      point.x = this._point.x + (event.delta.x * scaleX);
	    }
	    if (this.vertical) {
	      point.y = this._point.y + (event.delta.y * scaleY);
	    }
	...
	exports.LayerPinchable = (function(superClass) {
	  ...
	  LayerPinchable.prototype._pinchStart = function(event) {
	    ...
	    if (this.centerOrigin) {
	      return this._centerOrigin(event);
	    }
	  };
...
/***/ function(module, exports) {
	...
	exports.date = 1454588447;
	
	exports.branch = "master";
	
	exports.hash = "e57ec36";
